...
Purpose:
    This script facilitates the packaging of the Career Chief backend system. 
...
REPO_NAME = "career_chief"
AUTHOR_USER_NAME = "etietopabraham"
SRC_REPO = "careerchief"
...
setup(
    ...
    description="Backend system for Career Chief AI",
